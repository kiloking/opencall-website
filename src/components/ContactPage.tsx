            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div>filmfestival@chiayi.gov.tw</div>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div>週一至週五 09:00-17:00</div>
                </div>
              </div>
            </div>

            <div className="mt-8">
              <h2 className="text-xl mb-6 text-cyan-400">社群媒體</h2>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-gray-800 p-3 rounded-full hover:bg-cyan-400 hover:text-black transition-colors"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
